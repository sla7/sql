...
INSERT INTO project.orders VALUES (1,getdate(),'Paid',1, 45.00)
INSERT INTO project.orders VALUES (2,getdate(),'Paid',1, 11.99)
INSERT INTO project.orders VALUES (3,getdate(),'Paid',1, 65.00)
INSERT INTO project.orders VALUES (4,getdate(),'Paid',2, 1.29)
INSERT INTO project.orders VALUES (5,getdate(),'Paid',3, 20.00)
INSERT INTO project.orders VALUES (6,getdate(),'Paid',4, 25.00)
...
INSERT INTO project.paymentmethod VALUES (3,400,'4352-5423-6675-1111','Andrew Lee','03/05/2020','196',102);
...
INSERT INTO project.track VALUES ('T1','Lose Yourself','Hip Hop',900, 800, 700, 0.79);
INSERT INTO project.track VALUES ('T2','Wolves','Hip Hop',901, 801, 700, 0.99);
INSERT INTO project.track VALUES ('T3','Numb','Rock',902, 802, 700, 0.99);
INSERT INTO project.track VALUES ('T4','Too Good at Goodbyes','Pop',903, 803, 700, 0.99);
INSERT INTO project.track VALUES ('T5','Hello','Pop',904, 804, 700, 1.29);
INSERT INTO project.track VALUES ('T6','Fireworks','R&B',905, 805, 700, 1.29);
INSERT INTO project.track VALUES ('T7','In The Morning','Hip Hop',906, 806, 700, 1.29);
INSERT INTO project.track VALUES ('T8','Havana','Pop',907, 808, 700, 1.29);
INSERT INTO project.track VALUES ('T9','Shape of You','Pop',NULL, 809, 700, 1.29);
...
INSERT INTO project.album VALUES ('A1','8 Mile', 2002, 'Hip Hop', 701, 800, 6.99);
INSERT INTO project.album VALUES ('A2','The Life of Pablo', 2004, 'Hip Hop', 701, 801, 11.99);
INSERT INTO project.album VALUES ('A3','Meteora', 2003, 'Rock', 701, 802, 7.99);
INSERT INTO project.album VALUES ('A4','The Thrill of It All', 2017, 'Pop', 701, 803, 9.99);
INSERT INTO project.album VALUES ('A5','25', 2015, 'Pop', 701, 804, 10.99);
INSERT INTO project.album VALUES ('A6','Thank Me Later', 2010, 'R&B', 701, 805, 6.99);
INSERT INTO project.album VALUES ('A7','Cole World', 2011, 'Hip Hop', 701, 806, 11.99);
INSERT INTO project.album VALUES ('A8','8 Mile', 2002, 'Hip Hop', 702, 800, 6.99);
INSERT INTO project.album VALUES ('A9','The Life of Pablo', 2004, 'Hip Hop', 702, 801, 11.99);
INSERT INTO project.album VALUES ('A10','Meteora', 2003, 'Rock', 702, 802, 7.99);
INSERT INTO project.album VALUES ('A11','The Thrill of It All', 2017, 'Pop', 702, 803, 9.99);
INSERT INTO project.album VALUES ('A12','25', 2015, 'Pop', 702, 804, 10.99);
INSERT INTO project.album VALUES ('A13','Thank Me Later', 2010, 'R&B', 702, 805, 6.99);
INSERT INTO project.album VALUES ('A14','Cole World', 2011, 'Hip Hop', 702, 806, 11.99);
INSERT INTO project.album VALUES ('A15','Heartbreak On A Full Moon', 2017, 'Hip Hop', 701, 807, 16.99);
INSERT INTO project.album VALUES ('A16','What Makes You Country', 2017, 'Country', 701, 818, 9.99);
...
CREATE TABLE projectdraft.order_line(
  ...
  PRIMARY KEY (Order_Line_id),
  FOREIGN KEY (Order_id) REFERENCES projectdraft.orders(Order_id),
  FOREIGN KEY (SKU_id) REFERENCES projectdraft.inventory(SKU_id)
);

INSERT INTO projectdraft.order_line VALUES (300,'Purchase', 2,'X1TICK12', 12/04/2017, NULL, NULL);
INSERT INTO projectdraft.order_line VALUES (301,'Purchase', 1,'X1M6', 11/01/2017, dateadd(day, 30, getdate()), NULL);
INSERT INTO projectdraft.order_line VALUES (301,'Purchase', 1,'X1M2', 11/01/2017, dateadd(day, 30, getdate()), NULL);
INSERT INTO projectdraft.order_line VALUES (301,'Purchase', 2,'X1A13', 11/01/2017, dateadd(day, 30, getdate()), NULL);
INSERT INTO projectdraft.order_line VALUES (302,'Purchase', 1,'X1A17', 09/10/2017, NULL, NULL);
INSERT INTO projectdraft.order_line VALUES (303,'Purchase', 1,'X1T4', 10/22/2017, NULL, NULL);
INSERT INTO projectdraft.order_line VALUES (304,'Return', 1,'X1M6', 11/15/2017, NULL, 301);
